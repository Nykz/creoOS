...
import { createWorkspace, requestCompanyAccess, useWorkspaceAccess, WorkspaceAccessProvider } from "@/features/workspace/workspace-access";
...
function OnboardingContent() {
  ...
  async function submitJoin(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await requestCompanyAccess({ slug: companyCode, requestedRole: String(form.get("role") || "viewer") });
